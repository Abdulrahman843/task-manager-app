...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./error-404.d2935360.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./error-500.6a548ea8.js").then((r) => r.default || r));
...
//# sourceMappingURL=error-component.211fcecd.js.map

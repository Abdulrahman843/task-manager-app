...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/index.f3a5ad4e.js").then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import("./_nuxt/error-component.211fcecd.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
